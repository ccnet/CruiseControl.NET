...
namespace ThoughtWorks.CruiseControl.CCTrayLib.X10
{
	...
	/// </summary>
	public class X10LowLevelDriver : IX10LowLevelDriver
	{
		[Flags]
		...
		private HouseCode x10HouseCode; //House code to controll
		...
		private const ControllerType controller = ControllerType.CM11A; //Controller Type
		...
		public X10LowLevelDriver(HouseCode houseCode, string comPort, int baudRate, Parity parity, int dataBits,
		                          StopBits stopBits)
		{
			try
			{
		...
		public X10LowLevelDriver(HouseCode houseCode, string comPort)
