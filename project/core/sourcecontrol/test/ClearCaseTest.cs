...
namespace ThoughtWorks.CruiseControl.Core.Sourcecontrol.Test
{
	...
	<viewName>{5}</viewName>
		...
		{
			string since = "02-Feb-2002.05:00:00";
			string expectedArguments =  "lshist  -r  -nco -since " + since + " -fmt \"%u"
			...
			ProcessInfo processInfo = _clearCase.CreateHistoryProcessInfo( DateTime.Parse(since), DateTime.Now );
