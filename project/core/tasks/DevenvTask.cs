                ...
                : TaskBase
    {
        ...
        private string ReadDevenvExecutableFromRegistry()
        {
            ...
            switch (Version)
            {
                case "VS2010":
                case "10.0":
                    path = registry.GetLocalMachineSubKeyValue(VS2010_REGISTRY_PATH.Replace(@"Software\Microsoft\", @"Software\Wow6432Node\Microsoft\"), VS_REGISTRY_KEY);
                    if (path == null) path = registry.GetExpectedLocalMachineSubKeyValue(VS2010_REGISTRY_PATH, VS_REGISTRY_KEY);
                    break;
                case "VS2008":
                case "9.0":
                    path = registry.GetLocalMachineSubKeyValue(VS2008_REGISTRY_PATH.Replace(@"Software\Microsoft\", @"Software\Wow6432Node\Microsoft\"), VS_REGISTRY_KEY);
                    path = registry.GetExpectedLocalMachineSubKeyValue(VS2008_REGISTRY_PATH, VS_REGISTRY_KEY);
                    break;
                case "VS2005":
                case "8.0":
                    path = registry.GetLocalMachineSubKeyValue(VS2005_REGISTRY_PATH.Replace(@"Software\Microsoft\", @"Software\Wow6432Node\Microsoft\"), VS_REGISTRY_KEY);
                    path = registry.GetExpectedLocalMachineSubKeyValue(VS2005_REGISTRY_PATH, VS_REGISTRY_KEY);
                    break;
                case "VS2003":
                case "7.1":
                    path = registry.GetLocalMachineSubKeyValue(VS2003_REGISTRY_PATH.Replace(@"Software\Microsoft\", @"Software\Wow6432Node\Microsoft\"), VS_REGISTRY_KEY);
                    path = registry.GetExpectedLocalMachineSubKeyValue(VS2003_REGISTRY_PATH, VS_REGISTRY_KEY);
                    break;
                case "VS2002":
                case "7.0":
                    path = registry.GetLocalMachineSubKeyValue(VS2002_REGISTRY_PATH.Replace(@"Software\Microsoft\", @"Software\Wow6432Node\Microsoft\"), VS_REGISTRY_KEY);
