...
namespace ThoughtWorks.CruiseControl.UnitTests.WebDashboard.Plugins.ViewBuildLog
{
	[TestFixture]
	public class ViewBuildLogActionTest
	{
		private ViewBuildLogAction action;
		...
		public void Setup()
		{
			...
			action = new ViewBuildLogAction((IBuildRetriever) buildRetrieverMock.MockInstance);
