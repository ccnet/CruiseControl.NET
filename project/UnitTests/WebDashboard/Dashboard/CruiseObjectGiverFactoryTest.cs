...
{
	[TestFixture]
	public class CruiseObjectGiverFactoryTest
	{
		[Test]
		public void ShouldReturnAnObjectGiverThatCanGiveRequiredTypes()
		{
			...
			ObjectGiverAndRegistrar objectGiver = (ObjectGiverAndRegistrar) CruiseObjectGiverFactory.CreateGiverForRequest(request, context, control);
