...
namespace ThoughtWorks.CruiseControl.UnitTests.Core.Security
{
    ...
    public class RolePermissionTests
    {
        ...
        {
            RolePermission assertion = new RolePermission("testrole", SecurityRight.Inherit, SecurityRight.Inherit, SecurityRight.Allow, SecurityRight.Inherit, SecurityRight.Inherit, new UserName("johndoe"));
