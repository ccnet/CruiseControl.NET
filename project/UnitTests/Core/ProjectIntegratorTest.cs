...
namespace ThoughtWorks.CruiseControl.UnitTests.Core
{
	...
	public class ProjectIntegratorTest : IntegrationFixture
	{
        ...
        // ***************************************************** //
        // The following tests have been commented out because of a
        // compilation error on CCNetLive. For some reason the code
        // on CCNetLive does not compile the WaitOne() statement on
        // the ManualResetEvent. Without this line the unit tests
        // will fail as we cannot guarentee the order of processing
        // due to the multithreaded nature of the integrators.
        // ***************************************************** //
        //[Test]
