...
namespace ThoughtWorks.CruiseControl.UnitTests.CCTrayLib
{
	...
	public class StatusMonitorTransitionChangeTest
	{
		...
		public void ShouldNotifyPollEventWhenPollingAndNotInvokeError()
		{
			...
			ProjectStatus status = new ProjectStatus(ProjectIntegratorState.Running, IntegrationStatus.Success, ProjectActivity.Sleeping, "foo", "http://foo.bar", DateTime.Now, "Foo", null, DateTime.Now);
