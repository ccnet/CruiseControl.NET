...
namespace ThoughtWorks.CruiseControl.WebDashboard.Dashboard
{
    public class ProjectGridParameters
    {
                                                        ...
                                                        ICruiseUrlBuilder urlBuilder, IFarmService farmService, Translations translation)
        {
            ...
            this.forceBuildActionName = forceBuildactionName;
        ...
        public ProjectStatusOnServer[] StatusList
        {
            get { return statusList; }
        }

        public ProjectGridSortColumn SortColumn
        {
        ...
        public IFarmService FarmService
        {
            get { return farmService; }
        }
