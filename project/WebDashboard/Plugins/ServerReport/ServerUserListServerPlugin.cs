		...
		public IResponse Execute(ICruiseRequest request)
		{
			...
			else
			{
				if (action == "Reset password")
				{
					...
					try
					{
						string sessionToken = sessionRetriever.RetrieveSessionToken(request.Request);
						farmService.ResetPassword(request.ServerName, sessionToken, userName, resetPassword);
