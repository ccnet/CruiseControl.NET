...
namespace ThoughtWorks.CruiseControl.Shared.Entities.Logging 
{
	/// <summary>
	/// Provides utility methods for dealing with log files.
	/// </summary>
	// TODO copied from core, need to sort out unit test
	// TODO commented out references to remote stuff - need to fix
